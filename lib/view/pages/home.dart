...
import 'package:brainboost/view/widgets/cards/profile_header.dart';
import 'package:brainboost/services/user.dart';
import 'package:brainboost/view/widgets/history_item.dart';
import 'package:brainboost/view/widgets/circular_page_chart.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    final ThemeData currentTheme = context.watch<ThemeProvider>().theme;

    return Scaffold(
      backgroundColor: currentTheme == ThemeData.dark()
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            GoRouter.of(context).go(Routes.gamePage,
                                extra: {'showAddGame': true});
                          },
          ...
          Row(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  color:
                      isDarkMode ? AppColors.textPrimary : AppColors.buttonText,
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color:
                              isDarkMode ? Colors.white : AppColors.buttonText,
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
