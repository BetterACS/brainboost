...
import 'package:brainboost/view/widgets/panel_slider.dart';
...
import 'package:brainboost/services/utils/game_creator.dart';
              ...
              child: IconButton(
                ...
                onPressed: () {
                  if (_currentPage < games.length) {
                    ...
                    String gameHash =
                        _extractHashFromPath(games[_currentPage].ref);
